        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataInicioProjeto = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DataFimProjeto = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserHabilidades", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserHabilidades_Habilidades_IdHabilidade",
                        column: x => x.IdHabilidade,
                        principalTable: "Habilidades",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserHabilidades_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comentarios_Projects_IdProjeto",
                        column: x => x.IdProjeto,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Comentarios_Users_IdUser",
                        column: x => x.IdUser,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserHabilidades_IdHabilidade",
                table: "UserHabilidades",
                column: "IdHabilidade");

            migrationBuilder.CreateIndex(
                name: "IX_UserHabilidades_UserId",
                table: "UserHabilidades",
                column: "UserId");
        }
